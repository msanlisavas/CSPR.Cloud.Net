...
namespace CSPR.Cloud.Net.Clients.Api
{
    public static class Endpoints
    {
        ...
        public static class Validator
        {
            ...
            public static string GetHistoricalAverageValidatorsPerformance(string baseUrl, ValidatorsHistoricalAveragePerformanceRequestParameters requestParams = null)
            {
                var url = $"{baseUrl}{BaseUrls.GetHistoricalValidatorsAveragePerformance}";
                if (requestParams != null)
                {
                    var filterParameters = CasperHelpers.CreateFilteringParameters(requestParams.FilterParameters);
                    var sortingParameters = CasperHelpers.CreateSortingParameters(requestParams.SortingParameters);
            ...
            public static string GetValidatorTotalRewards(string baseUrl, string publicKey)
            {
